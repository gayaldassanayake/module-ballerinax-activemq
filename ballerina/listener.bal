...
public isolated class Listener {
    ...
    #
    # ```ballerina
    # classic:Listener listener = check new ("tcp://localhost:61616",
    #     username = "admin",
    #     password = "admin"
    # );
    # ```
    ...
    #
    # + s - The ActiveMQ service to attach (must be annotated with `@classic:ServiceConfig`)
    # + name - Optional parameter, reserved for future use (currently ignored)
    # + return - `classic:Error` if the attachment fails, `()` otherwise
    ...
    # + return - `classic:Error` if the detachment fails, `()` otherwise
    ...
    #
    # + return - `classic:Error` if starting fails, `()` otherwise
    ...
    #
    # + return - `classic:Error` if stopping fails, `()` otherwise
